...
@Component({
  selector: 'app-verification-front',
  templateUrl: './verification-front.component.html',
  styleUrls: ['./verification-front.component.scss']
})

export class VerificationFrontComponent implements OnInit {
  user: User;
  ...
  ngOnInit(): void {
    ...
    let modalRef = this.modalService.open(NgbdModalFrontVerification);
...
export class NgbdModalFrontVerification {
  form: FormGroup;
